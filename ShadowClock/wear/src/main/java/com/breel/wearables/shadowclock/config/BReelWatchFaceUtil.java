...
public final class BReelWatchFaceUtil {
    ...
    /**
     * Asynchronously fetches the current config {@link DataMap} for {@link BReelWatchFaceUtil} and
    ...
    /**
     * Overwrites the current config {@link com.google.android.gms.wearable.DataItem}'s {@link DataMap} with {@code newConfig}. If
